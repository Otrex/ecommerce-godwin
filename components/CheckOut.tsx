...
export default function CheckOut({ showCheckout }: { showCheckout: boolean }) {
  return (
    <div className="relative z-10" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
  <div className={`fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity ${!showCheckout && 'hidden'}`}></div>

  <div className={`fixed inset-0 overflow-hidden ${!showCheckout && 'hidden'}`}>
